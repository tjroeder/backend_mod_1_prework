...
# For is_hungry I used a boolean as *most* the time you are either hungry or you are not.
# 0 or 1. Though there are sometimes where you are both... we may need qubits to accurately
# describe hunger states.

# For number_of_pets I used an integer as you cannot have fractions of a pet to my knowledge.
# Please do not fractionalize your pet. As well, if you were to save as a string, you would
# not be able to use the value for computation.
...
# Yes. I tested a couple times and found I had made a couple mistakes along the way, and I was
